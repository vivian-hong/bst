...
private:
        ...
        //helper functions for remove function
        void no_children(Node *node, Node *parent);
        void one_child(Node *node, Node *child, Node *parent);
        void two_children(Node *node);
        //helper function for insert function
        void insert_help(Node *node, int value);
};
