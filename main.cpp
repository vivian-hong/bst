...
/*
void test_function(BinarySearchTree &bst)
{
	int values[7] = {-5,17,10,2,4,-3,12};
	for (int i=0;i<7;i++) {
		bst.insert(values[i]);
	}
	print_tree_details(bst);

	cout<< "removing 1 from original tree:"<< endl;
	bst.remove(1);
	print_tree_details(bst);

	cout<< "removing 2 from original tree:"<< endl;
	bst.remove(2);
	print_tree_details(bst);

	cout<< "removing 4 from original tree:"<< endl;
	bst.remove(4);
	print_tree_details(bst);

	cout<< "removing 10 from original tree:"<< endl;
	bst.remove(10);
	print_tree_details(bst);

	cout<< "removing -5 from original tree:"<< endl;
	bst.remove(-5);
	print_tree_details(bst);
